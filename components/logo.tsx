    ...
    <svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id="tealGradient" x1="0%" y1="0%" x2="0%" y2="100%">
          ...
          <stop offset="100%" style={{ stopColor: "#00B8A9", stopOpacity: 1 }} />
        </linearGradient>

        <symbol id="person" viewBox="0 0 409.165 409.164">
          <g>
      ...
      <use href="#person" x="150" y="10" width="100" height="100" fill="url(#tealGradient)" />
      <use href="#person" x="90" y="110" width="100" height="100" fill="url(#tealGradient)" />
      <use href="#person" x="210" y="110" width="100" height="100" fill="url(#tealGradient)" />
      <use href="#person" x="30" y="210" width="100" height="100" fill="url(#tealGradient)" />
      <use href="#person" x="150" y="210" width="100" height="100" fill="url(#tealGradient)" />
      <use href="#person" x="270" y="210" width="100" height="100" fill="url(#tealGradient)" />
    </svg>
  )
}

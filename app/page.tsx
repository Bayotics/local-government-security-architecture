      ...
      <div ref={smoothWrapperRef} id="smooth-wrapper" className="overflow-hidden">
        <div ref={smoothContentRef} id="smooth-content">
          ...
          >
              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {[
                    ...
                    <div
                      key={index}
                      className="feature-card bg-[#1E293B] border border-[#64FFDA]/20 rounded-xl p-8 hover:border-[#64FFDA]/50 transition-all hover:shadow-lg hover:shadow-[#64FFDA]/20"
                    >
                      <div className="mb-6">
            ...
            <section className="dimensions-section relative py-20 px-4 bg-[#1E293B]/30">
              <div className="max-w-7xl mx-auto">
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    ...
                    <div
                      key={index}
                      className="dimension-card bg-[#0A192F] border border-[#64FFDA]/20 rounded-lg p-6 hover:border-[#64FFDA]/50 transition-all"
                    >
                ...
                >
                  ...
                  >
                    {fullAboutText.split('. ').map((sentence, index) => (
                      ...
                      >
                        {sentence}{sentence !== fullAboutText.split('. ').slice(-1)[0] ? '.' : ''}
                      </motion.p>
                    ))}
                  </motion.div>
